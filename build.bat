...
gcc bins/sha.o bins/aes.o bins/cbc.o bins/tlsbase.o bins/p256.o bins/x25519.o bins/bm256.o bins/prf.o bins/ber_entity.o bins/basics.o bins/gcm.o bins/gzip.o bins/converters.o bins/testtls.o -o tlsclient.exe -lws2_32 
